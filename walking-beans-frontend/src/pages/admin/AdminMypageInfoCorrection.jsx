...
function InfoCorrectionPage() {
    ...
    return (
        <div className={`info-correction-container  ${userRole}`}>
            <div className={`user-order-background ${userRole}`}>
                <div className={`user-order-menu-container ${userRole}`}>
                    <h2 className={`info-correction-title-center ${userRole}`}>회원정보 수정하기</h2>
                    <div className={`info-correction-hr ${userRole}`}></div>
                    <form>
